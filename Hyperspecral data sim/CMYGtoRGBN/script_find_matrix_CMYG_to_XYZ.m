...
bayer_CMYG = imread('colorchart_sunlight.pgm');
...
colorchart_sunlight_pos = [ 
                    1640, 1479; % dark skin 1573 1528
                    1640, 1266; % light skin 1576 1279
                    1645, 1041; % blue sky 1570 1033
                    1647, 815; % foliage 1570 781
                    1650, 587; % blue flower 1567 538
                    1650, 358; % bluish green 1558 295
                    1852, 1482; % orange 1822 1537
                    1865, 1261; % purplish blue 1822 1288
                    1868, 1043; % moderate red 1825 1030
                    1873, 818; % purple 1825 775
                    1871, 589; % yellow green 1816 526
                    1871. 361; % orange yellow 1810 280
                    2067, 1479; % blue 2089 1537
                    2078, 1261; % green 2080 1282
                    2080, 1041; % red 2089 1030
                    2088, 818; % yellow 2077 769
                    2088, 592; % magenta 2071 520
                    2096, 369; % cyan 2059 268
                    2280, 1476; % white(.05*) 2341 1543
                    2285, 1261; % neutral 8(.23*) 2338 1285
                    2338, 1027; % neutral 6.5(.44*) 2338 1027
                    2303, 820; % neutral 5(.70*) 2335 775
                    2306, 597; % neutral 3.5(.1.05*) 2335 514
                    2311, 374; % black (1.50*) 2323 250
                ];
...
cc_pos = colorchart_sunlight_pos;
